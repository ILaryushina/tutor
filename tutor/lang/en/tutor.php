...
$string['modulename'] = 'tutor';
$string['comdi'] = 'tutor';
$string['modulenameplural'] = 'tutors';
$string['modulename_help'] = 'Use the tutor module for videoconference. These videoconferences will use your Moodle username by displaying your username and avatar in videoconferences.

tutor-meet is an open-source videoconferencing solution that enables you to easily build and implement secure video conferencing solutions.';
$string['tutor:addinstance'] = 'Add a new tutor';
$string['tutor:moderation'] = 'tutor Moderation';
$string['tutor:sharedesktop'] = 'Share Desktop';
$string['tutor:view'] = 'View tutor';
$string['tutorname'] = 'Session name';
$string['tutor'] = 'tutor';
$string['pluginadministration'] = 'tutor administration';
$string['pluginname'] = 'tutor';
...
$string['server'] = 'tutor Server';
$string['serverexpl'] = 'tutor Server url';
$string['privacy:metadata:tutor'] = 'In order to integrate with a tutor session, user data needs to be exchanged with that service.';
$string['privacy:metadata:tutor:username'] = 'The username is sent from moodle to show to the other users of the tutor session';
$string['privacy:metadata:tutor:avatar'] = 'The avatar is sent from moodle to show to the other users of the tutor session';
$string['noviewpermission'] = 'You do not have permission for view this tutor session';
$string['minpretime'] = 'Minutes to access';
$string['help'] = 'Help';
$string['helpex'] = 'Instruction text for show at tutor activity';
...
$string['task_update_session_log'] = 'Update';